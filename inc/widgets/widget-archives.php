...
class sparkling_archives extends WP_Widget_Archives {
	...
	public function widget( $args, $instance ) {
		...
		<select id="<?php echo esc_attr( $dropdown_id ); ?>" class="postform form-control" name="archive-dropdown" onchange='document.location.href=this.options[this.selectedIndex].value;'>
			<?php
			/**
